...
def evaluation_models(model_name,data_loader, expansion_list = [8],  num_trails = 10,percentage = 1, use_age = False, norm_type= 'Instance'):
    ...
    for i,ep in enumerate(expansion_list):
        ...
        model = build_model_cascaded(cfg)
...
if __name__ == '__main__':
    ...
    t1_path_to_tsv = '/gpfs/home/lc3424/capstone/2021_dementia/lc3424_workspace/experiments/20211102/label_and_file_path/20211206/t1_test.tsv'
    flair_path_to_tsv = '/gpfs/home/lc3424/capstone/2021_dementia/lc3424_workspace/experiments/20211102/label_and_file_path/20211206/flair_test.tsv'

    Test_dataset = ADNI_3D_T1_FLAIR(t1_path_to_tsv, flair_path_to_tsv, n_label = cfg['model']['n_label'])
    ...
    model_file_name = 'volume_finetune_cascaded_train_perc_100.0_expansion_8'
